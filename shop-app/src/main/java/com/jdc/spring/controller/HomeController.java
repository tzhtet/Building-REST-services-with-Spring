...
public class HomeController {
	...
	@GetMapping
	String index(ProductSearch search, @RequestParam(required = false, defaultValue = "0") int page,
			@RequestParam(required = false, defaultValue = "12") int size, ModelMap model) {
